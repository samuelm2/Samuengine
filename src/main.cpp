...
void render(ShaderProgram& shaderProgram, GLuint vao) {
...
void cleanup(GLFWwindow* window, ShaderProgram& shaderProgram, GLuint& vao) {
...
int main(void) {    
    ...
    ShaderProgram shaderProgram(ASSETS_PATH"/shaders/test.vert.glsl", ASSETS_PATH"/shaders/test.frag.glsl");
